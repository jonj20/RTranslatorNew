...
public class TtsDownloader {
    ...
    public static void downloadModels(final Activity activity, ActivityManageLanguagesBinding binding, String model, String lang, String country, String type) {
        ...
        String onnxModelUrl = "https://hf-mirror.com/csukuangfj/"+ type + "-" + model + "/resolve/main/" + modelName;
        String tokensUrl = "https://hf-mirror.com/csukuangfj/" + type + "-" + model + "/resolve/main/tokens.txt";
